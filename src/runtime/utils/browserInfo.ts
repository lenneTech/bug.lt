...
export const getBrowserInfo = (): BrowserInfo => {
  ...
  return {
    ...
    languages: systemInfo?.languages || [navigator.language] as string[],
...
export const getSystemInfo = () => {
  ...
  const getBrowserDetails = (userAgent: string) => {
    const browsers = [
  ...
  const getOSDetails = (userAgent: string) => {
    const systems = [
...
export const getPerformanceInfo = () => {
  ...
  return {
    ...
    navigationStart: navigation.fetchStart, // Use fetchStart instead of navigationStart
